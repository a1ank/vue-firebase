            ...
            <v-card class="elevation-12">
              ...
              <v-card-text>
                ...
                <v-form v-model="valid">
                  <v-text-field prepend-icon="email" name="login" label="E-mail" type="email" required v-model="email"></v-text-field>
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="green darken-1" @click.prevent='signin' :disabled="processing">Войти</v-btn>
              </v-card-actions>
            </v-card>
          </v-flex>
        </v-layout>
